      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="relative">
          ...
          <div className="relative mt-1">
            <input
              ...
              className="block w-full rounded-md border border-gray-300 p-2 shadow-sm pr-10 focus:border-purple-500 focus:ring-purple-500"
              required
            />
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: isLoading ? "#ccc" : "#6b46c1",
          }}
          onClick={handleLogin}
